...
const config: Configuration = {
  ...
  head: {
    ...
    titleTemplate: '%s | 市原市 新型コロナウイルス感染症対策サイト(非公式)',
    meta: [
      { charset: 'utf-8' },
      ...
      { hid: 'og:type', property: 'og:type', content: 'website' },
      {
        hid: 'og:url',
        property: 'og:url',
        content: 'https://covid19-ichihara.netlify.app/'
      },
      {
        hid: 'og:title',
        property: 'og:title',
      ...
      },
      {
        hid: 'twitter:image',
        name: 'twitter:image',
        content: 'https://covid19-ichihara.netlify.app/ogp.png'
      },
      {
        hid: 'note:card',
        property: 'note:card',
  ...
  manifest: {
    name: '市原市 新型コロナウイルス感染症対策サイト(非公式)',
    theme_color: '#00a040',
